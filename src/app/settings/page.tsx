...
export default function SettingsPage() {
    ...
    return (
        <div className="space-y-6 pt-4 pb-20 fade-in max-w-5xl mx-auto w-full">
                ...
                <div className="space-y-6">
                    ...
                    <section className="space-y-3">
                        ...
                        <Card className="p-4 space-y-4">
                            ...
                            {isFilterDirty && (
                                <Button
                                    className="w-full h-10 font-bold tracking-wide shadow-[0_0_20px_rgba(176,38,255,0.15)] bg-gradient-to-r from-[#B026FF] to-[#FF2E93] text-black hover:opacity-90 transition-opacity"
            ...
            <section className="pt-8">
                <Button variant="danger" className="w-full md:w-auto md:px-12 h-12 rounded-xl border border-danger/30 hover:border-danger/60" onClick={handleSignOut}>
                    <LogOut size={18} className="mr-2" />
                    Sign Out
                </Button>
                <p className="text-[10px] text-center md:text-left text-textMuted mt-4 opacity-50 px-1">
                    PaisaPulse v1.3.0
                </p>
            </section>
        </div>
